...
<html lang="en">
	...
	<meta name="author" content="Jovefarm farm venture">
	<meta name="publisher" content="witttechnologies">
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
    <meta name="msapplication-TileImage" content="jovefarm.png">

	<!-- meta tag sessions end here -->
	<link rel="apple-touch-icon-precomposed" href="jovefarm.png">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.7.0/animate.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.carousel.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.carousel.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.theme.min.css">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.3.1/css/all.css" integrity="sha384-mzrmE5qonljUremFsqc01SB46JvROS7bZs3IO2EmfFsd15uHvIt+Y8vEf7N7fWAU" crossorigin="anonymous">
	<link rel="stylesheet" href="jovefarm10.css">
	<link rel="stylesheet" href="jovechat10.css">
	...
	<script src="file:///C:/xampp1/htdocs/jovehtfarm/jovefarm.js" type="text/javascript"></script>
	<link rel="icon" href="jovefarmpic/jovelogonew.png" sizes="32x32">
    <link rel="icon" href="jovefarmpic/jovelogonew.png" sizes="192x192">
    
<title> Jovefarms - FAQ </title>
<body>
    ...
    <div id="top-head" class=" animated slideInUp bg-blue py-2">
        <div class="container">
            <div class="d-flex align-items-center justify-content-between text-white">
                ...
                <div class="small d-flex contact-info">
                    ...
                    <div class="mr-0">
                        <a href="mailto:info@fbnmortgages.com"><i class="fa fa-user mr-2"></i>info@jovefarms.com</a>
                    </div>
                </div>
            </div>
        </div>
      ...
      <nav class="navbar animated slideInDown navbar-expand-lg navbar-dark sticky-top">
        ...
        <a class="navbar-brand" href="index.php">
            <img width="200px" height="50px" src="jovefarmpic/jovefarmlogo.png" alt="">
        </a>
...
function closeSearch() {
    ...
    document.getElementById("firstList").style.display = "flex";
      ...
      <a href="https://www.facebook.com/jovefarm.venture.9" class="facebook"><i class="fab fa-facebook"></i></a> 
        ...
        <a href="mailto:jovefarmsventure@gmail.com" class="google"><i class="fab fa-google"></i></a> 
      ...
      <style>
		...
		$(function(){
			...
			<section class="mb-4">
		<div class="container">
		<div class="secondary pt-4" style="height: 400px; width: 100%; background-image: url('jovefarmpic/cs1.jpg'); background-size: cover; background-position:center; background-repeat: no-repeat;">
	<div class="shell">
		<p style="background: #eee; font-style: italic; color: #fff;" class="bread">
	<a href="/" target="_self">Home</a> <span>/</span> <a href="faq.php" target="_self">Frequently Asked Questions</a></p><!-- /.breadcrumbs -->
		
					<div style="background: #eee; padding: 30px;" class="intro-content">
									<h2 style="color: coral; font-size: 40px;" class="intro-title">Find a Quick, and Clear <br/> Answer(s) to your Question(s)</h2>
				
									<h4 style="color: green;">We are an agric-tech platform focused on connecting farmers with farm funders for the purpose of increasing food production, ensuring food security, and create employment oppurtunities in Nigeria</h4>
							</div><!-- /.intro-content -->
			</div><!-- /.shell -->
</div>
		<!--<div class="offset-2">-->
		...
		Click on the button on the right to see the frequently Asked Questions. Thanks.
		</div>
		<div class="col-lg-10">
		<div class="col-lg-12 btn btn-lg btn-success" data-toggle="collapse" href="#collapseExample" role="button"  aria-controls="collapseExample">
	
								<p style="font-size: 20px;" class="text-left">Click to know more about JoveFarms</p>
						
							<i id="i" class="text-right fa fa-arrow-down"></i></div>
							
							<div  class="collapse" id="collapseExample">	
					<h4 id="learn" style="margin: 10px 0; cursor: pointer;  font-weight: 800;" class="py-3  px-lg-2 mb-2" data-toggle="collapse" href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample">Click and learn what we do at Jovefarm</h4>
				
			<div  id="collapseExample1" class="pl-lg-5 pl-md-2 pt-2 col1 collapse">
				<div style="margin-bottom: 3px;" id="textbolder" class="text-bolder px-4 mt-2" data-toggle="collapse" href="#collapseExample2" role="button" aria-expanded="false" aria-controls="collapseExample2">What is Jovefarms?<i style="float:right;" class="plus fas fa-minus fa-2x"></i><!--<i style="float:right;" id="plus" class="text-right fas fa-plus fa-2x"></i>--></div>
				<div class="collapse multi-collapse" id="collapseExample2">
				<p><span style="text-align: left !important;" style="font-weight: 500;">JoveFarms is Nigeria’s 1st agric tech company whose mission is to end poverty in Africa, one rural farmer at a time. We do this by creating an online platform for “everyday people'', to engage in the agricultural value chain by sponsoring farms in rural communities.</span></p>
				</div>
				<div style="margin-bottom: 3px;" id="textbolder" class="text-bolder px-4" data-toggle="collapse" href="#collapseExample5" role="button" aria-expanded="false" aria-controls="collapseExample">What does Jovefarms do?<i style="float:right;" class="plus1 fas fa-minus fa-2x"></i></div>
				...
				<div style="margin-bottom: 3px;" id="textbolder" class="text-bolder px-4" data-toggle="collapse" href="#collapseExample3"  role="button" aria-expanded="false" aria-controls="collapseExample2 collapseExample3">Who is behind the idea of Jovefarms?<i style="float:right;" class="plus2 fas fa-minus fa-2x"></i></div>
...
<p><span style="font-weight: 500;">  - 4 years financial management expertise</span></p>
				...
				<div style="margin-top: 20px;" class="col-lg-12 btn btn-lg btn-success" data-toggle="collapse" href="#collapseExample6" role="button"  aria-controls="collapseExample6">
	
								<p style="font-size: 20px;" class="text-left">How to start Farming</p>
						
							<i id="i1" class="text-right fa fa-arrow-down"></i></div>
			...
			<div style="margin-bottom: 3px;" id="textbolder1" class="text-bolder1 px-4" data-toggle="collapse" href="#collapseExample8" role="button" aria-expanded="false" aria-controls="collapseExample8">How does this work?<i style="float:right;" class="plus4 fas fa-minus fa-2x"></i></div>
				...
				<p><span style="text-align: left !important;" style="font-weight: 500;">First you have to sign up on our website to create your own personalised JoveFarms' profile, you then select a farm of choice to fund. You sponsor the farm, and at the end of the farm cycle stipulated, you will receive a percentage of the profit after the sales of harvest and also your initial Investment capital.</span></p>
				</div>
			<div style="margin-bottom: 3px;" id="textbolder1" class="text-bolder1 px-4" data-toggle="collapse" href="#collapseExample9" role="button" aria-expanded="false" aria-controls="collapseExample9">How do I join JoveFarms?<i style="float:right;" class="plus5 fas fa-minus fa-2x"></i></div>
...
<p><span style="font-weight: 400;">You will be directed to a page that requires you to sign up using either your facebook account or an existing email address. An authentication email will be sent to your personal email address, confirm your email address, and automatically you get a JoveFarms Profile Page.</span></p>
<p><span style="font-weight: 400;">Please fill in all the details required.</span></p>
		...
		<div style="margin-bottom: 3px;" id="textbolder1" class="text-bolder1 px-4" data-toggle="collapse" href="#collapseExample10"  role="button" aria-expanded="false" aria-controls="collapseExample9 collapseExample10">How do I become a Farm follower?<i style="float:right;" class="plus6 fas fa-minus fa-2x"></i></div>
				...
				<p><span style="font-weight: 400;">Visit our homepage and ‘Sign Up’, to create your unique JoveFarms Profile by providing all the information required. You can either sign up with your email address or your Facebook account.</span></p>
...
<p><span style="font-weight: 400;">After that select the payment options of either 'Paystack' or 'Simplepay', you will be required to complete the transaction with your ATM Card or you may chose the bank transfer option which would require you to use your bank token to complete the transaction.</span></p>
				...
				<div style="margin-top: 20px;" class="col-lg-12 btn btn-lg btn-success" data-toggle="collapse" href="#collapseExample12" role="button" aria-expanded="false" aria-controls="collapseExample12">
	
								<p style="font-size: 20px;" class="text-left">Understanding how my sponsorship works</p>
						
							<i id="i2" class="text-right fa fa-arrow-down"></i></div>
...
<p><span style="font-weight: 400;">JoveFarms - 20% of the profit </span></p>
<p><span style="font-weight: 400;">The Farm Sponsor’s share of the profit is equivalent to the Returns-After-Harvest which is displayed on the farms. For example, currently our Poultry Unit Returns is 15%, the 15% flat rate is what amounts to 40% of the profit share on the poultry farm.</span></p>
				...
				<p><span style="font-weight: 500;"> Yes, you can invite friends from any social media platforms such as Facebook, Twitter and others to join you on JoveFarms.</span></p>
				</div>
				</div>
				</div>
				</div>
