...
<div style="margin: none; padding: none;background-image: url('jovefarmpic/img3.jpg'); height: 200px; background-repeat: no-repeat; background-size: cover; background-position: center;" class="text-center text-white"> <h1 style="padding-top: 80px">Poultry </h1></div>
<section class="pt-5 px-lg-4">
<div class="container">
<div class="row">
<div class="col-lg-4">
<img src="jovefarmpic/poultry1.png" height="350px" width="100%" alt="poultryfarm">
</div>
<div id="amountpoultry" class="col-lg-3">
<p>Minimum Investment : <b style="font-size: 26px;"><span  class="mr-2" style="color: lightcoral;">&#8358;</span>5,000,000</b> </p>
<p style="font-size: 18px;"> Poultry Farm Unit(s) left: <b> 2</b> </p>
...
<hr>
<div class="desc pt-4 col-lg-10">
<h3 class="mb-3">Farm Description</h3>
<hr>
<p>Nigeria has an annual deficit of over 60 million tons of chicken meat processed from boiler valued at 120 Trillion Naira. Importation takes up about 40 percent of local consumption. With the high dollar rates, the gap in supply will increase.

Our farmers have specialized in rearing poultry chicken with zero to low fat.</p>

<p>What does my sponsorship cover? </p>
<hr>

<p>1) Renting the poultry on your behalf</p>

<p>3) Farm inputs including the chicks, feeding and treatment against any form of disease</p>

<p>4) Farmers labour to work on the farm</p>

</p>5) Logistics to get the Soya to the market to sell them</p>
<hr>
