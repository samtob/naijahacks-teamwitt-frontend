...
<div style="margin: none; padding: none;background-image: url('jovefarmpic/maize.jpg'); height: 200px; background-repeat: no-repeat; background-size: cover; background-position: center;" class="text-center text-white"> <h1 style="padding-top: 80px">Maize</h1></div>
<section class="pt-5 px-lg-4">
<div class="container">
<div class="row">
<div class="col-lg-4">
<img src="jovefarmpic/maize1.jpg" height="350px" width="100%" alt="poultryfarm">
</div>
<div id="amountmaize" class="col-lg-3">
<p>Minimum Investment : <b style="font-size: 26px;"><span  class="mr-2" style="color: lightcoral;">&#8358;</span>5,000,000</b> </p>
<p style="font-size: 18px;"> Maize Farm Unit(s) left: <b> 2</b> </p>
...
<hr>
<div class="desc1 pt-4 col-lg-10">
<h3 class="mb-3">Farm Description</h3>
<hr>
<p>Maize also known as corn, botanical name is <b> Zea Mays </b>, is a large grain plant first domesticated by indigenous people in Mexico about 10,000 years ago.
