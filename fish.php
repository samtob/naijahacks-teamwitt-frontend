...
<section class="pt-3 px-lg-4">
<div class="container">
<div class="row">
<div class="col-lg-4">
<img src="jovefarmpic/fish.jpg" height="350px" width="100%" alt="poultryfarm">
</div>
<div id="amountfish" class="col-lg-3">
<p>Minimum Investment : <b style="font-size: 26px;"><span  class="mr-2" style="color: lightcoral;">&#8358;</span>5,000,000</b> </p>
<p style="font-size: 18px;"> Fish Farm Unit(s) left: <b> 2</b> </p>
...
<hr>
<div class="desc6 pt-4 col-lg-10">
<h3 class="mb-3">Farm Description</h3>
<hr>
<p>Nigeria has an annual deficit of over 50 million tons of  Fish valued at 120 Trillion Naira. Importation takes up about 40 percent of local consumption. With the high dollar rates, the gap in supply will increase.

Our farmers have specialized in rearing fish with zero to low fat.

<p>What does my sponsorship cover? </p>
<hr>

<p>1) Renting the Fish farm on your behalf</p>

<p>2) Farm inputs including the Fish, feeding and treatment against any form of disease</p>

<p>3) Farmers labour to work on the farm</p>

</p>4) Logistics to get the chicken to the market to sell them</p>
<hr>
