...
<div style="margin: none; padding: none;background-image: url('jovefarmpic/palm.jpg'); height: 200px; background-repeat: no-repeat; background-size: cover; background-position: center;" class="text-center text-white"> <h1 style="padding-top: 80px">Palm </h1></div>
<section class="pt-5 px-lg-4">
<div class="container">
<div class="row">
<div class="col-lg-4">
<img src="jovefarmpic/palm1.jpg" height="350px" width="100%" alt="poultryfarm">
</div>
<div id="amountpalm" class="col-lg-3">
<p>Minimum Investment : <b style="font-size: 26px;"><span  class="mr-2" style="color: lightcoral;">&#8358;</span>5,000,000</b> </p>
<p style="font-size: 18px;"> Palm Farm Unit(s) left: <b> 2</b> </p>
...
<hr>
<div class="desc3 pt-4 col-lg-10">
<h3 class="mb-3">Farm Description</h3>
<hr>
<p>Nigeria has an annual deficit of over 60 million tons of Palm  valued at 20  Trillion Naira. Importation takes up about 40 percent of local consumption. With the high dollar rates, the gap in supply will increase.

Our farmers have specialized in cultivating palm with zero to low fat.
 </p>
 <p>What does my sponsorship cover? </p>
<hr>

<p>1) Renting the poultry farm on your behalf</p>
